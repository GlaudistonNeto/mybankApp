...
export default SendRequestScreen = () => {
  ...
  const convertToDollars = (currentAmount) => {
    ...
    return newAmount.toLocaleString("en-US", { style: "currency",
      currency: "USD" });
  };
  ...
  return (
    <Container>
      ...
      <Amount>
        ...
        <Text bold color="#727479">Choose an amount to send</Text>
      </Amount>
      ...
      <Send>
        <Text medium heavy>Send {convertToDollars(amount)} to Me</Text>
      </Send>
